...
| **3** | **(Bạn)** | **Controller + Service** cho **Đặt hàng & Quản lý đơn hàng** (bao gồm thống kê, doanh thu) |
| **4** | **Mạnh Đức** | **Đăng ký, đăng nhập, phân quyền (Spring Security)** |
| **5** | **UI/Frontend (Thymeleaf + Bootstrap)** | Thiết kế giao diện người dùng & admin |
